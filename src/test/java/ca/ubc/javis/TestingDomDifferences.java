...
public class TestingDomDifferences {
	...
	public void testGetDomDifferences() throws IOException, InterruptedException {
		String id="1";
		String firstDom = "<html><body><div id='div1'>Hello</div><a id='a1'>Go to Google</a></body></html>";
		String secondDom = "<html><body><div id='div2'>Bye</div><img id='img1' width='23' height='21'/></body></html>";
