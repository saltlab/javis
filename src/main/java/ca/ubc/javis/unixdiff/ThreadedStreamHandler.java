 ...
 * 
 * Please ee the following page for the LGPL license: http://www.gnu.org/licenses/lgpl.txt
 * 
 */
class ThreadedStreamHandler extends Thread {
	...
	/**
	 * A simple constructor for when the sudo command is not necessary. This constructor will just
	 * run the command you provide, without running sudo before the command, and without expecting a
	 * password.
	 * 
	 * @param inputStream
	 * @param streamType
